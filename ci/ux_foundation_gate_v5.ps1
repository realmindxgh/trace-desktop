...
$receipt=$receiptMarker+"`r`nphase3_patch_sha256=0b61b70a4bd676518b59500090ea2a9cd77a48a37564f55682ac9da2a8eb4b0b`r`nphase3_xz_sha256=33776b10bed121116c321c1e3a7639c6de3fc80b5d59395c80c19479b2dd9fea`r`nphase3_logic_green=true`r`nphase4_patch_sha256=4ec781b1c2648768ce2372834ff4d73f44a7a2d4d1979162acd07ce241f502f3`r`nphase4_xz_sha256=f8129cea9f12efef9977e14c3d038704103691e457acd671698d6f0194d99028`r`nphase4_logic_green=true`r`nux_foundation_contract_checks=82"
$base=$base.Replace($receiptMarker,$receipt)

$expanded=Join-Path $env:RUNNER_TEMP 'trace-ux-foundation-expanded-v5.ps1'
Set-Content $expanded $base
& pwsh -NoProfile -File $expanded
if($LASTEXITCODE -ne 0){ throw 'Expanded Phase 4 Windows gate failed.' }
