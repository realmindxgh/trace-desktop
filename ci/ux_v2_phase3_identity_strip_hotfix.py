...
for required in ('has-workspace-identity','Open source context','prepareWorkspaceForOpen','openTraceContextMenu','offerMediaImportChoice','default-transcription-language','project-export-prefix'):
...
print('Source identity strip, stable Saved status, human errors, desktop interaction, media choices and project/application settings applied')
