...
for req in ('renderCodeContextRail','data-code-context','code-context-search','Browse all sources'):
    if req not in check:
        raise SystemExit(f'Phase 5 Code context contract missing: {req}')
print('Phase 5 Code-system contextual rail hotfix applied')
