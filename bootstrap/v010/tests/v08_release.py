...
installer_js=(ROOT/'setup-shell/src/app.js').read_text(encoding='utf-8')
...
for command in ['action_availability','undo_last_action','redo_last_action','begin_project_session','heartbeat_project_session','end_project_session','on_window_event','ACTIVE_SESSION']:
